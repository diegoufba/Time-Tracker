...
final watchStateProvider =
    StateProvider((ref) => 0); // {zero = 0, started = 1, paused = 2}
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void handleMainButtonClick(bool retake) {
      if (watchState == 0 || retake) {
        ...
        _timer = Timer.periodic(const Duration(seconds: 1), (Timer t) {
          ...
          if (!isStopWatch &&
              _stopwatch.elapsed.inMinutes >= pomodoroDuration.inMinutes) {
            //pomodoro finishes
            t.cancel();
    ...
    return Column(
      ...
      children: [
        ...
        if (pomodoroDuration.inMinutes == 5) ...[
          //rest time message
          const Text("Descanso")
        ],
        ...
        Row(
          ...
          children: [
            ...
            if ((isStopWatch && watchState != 2) ||
                (!isStopWatch && watchState == 2)) ...[
              //retake button
              ElevatedButton.icon(
